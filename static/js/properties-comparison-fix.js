...
class SimpleComparisonManager {
    ...
    async loadFromDatabase() {
        try {
            ...
            if (data.success) {
                this.comparisons = data.properties.map(p => String(p.property_id)) || [];
                this.complexComparisons = data.complexes.map(c => String(c.complex_id)) || [];
                console.log('✅ Загружено из БД - квартиры:', this.comparisons.length, 'ЖК:', this.complexComparisons.length);
            } else {
