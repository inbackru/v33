...
# Initialize CSRF protection after app creation - TEMPORARILY DISABLED FOR DEBUG
# csrf = CSRFProtect(app)
csrf = None  # Отключено для диагностики входа
...
def get_manager_clients_unified():
    ...
    try:
        ...
        # Get ONLY buyers assigned to this manager
        clients = User.query.filter_by(role='buyer', assigned_manager_id=manager_id).all()
